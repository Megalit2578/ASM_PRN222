...
public class ChapterService : IChapterService
{
    ...
    public async Task<List<DTOs.ChapterDto>> GetBySubjectAsync(string subjectId) { var entities = await _repo.GetBySubjectAsync(subjectId); return _mapper.Map<List<DTOs.ChapterDto>>(entities); }
    public async Task<List<DTOs.ChapterDto>> GetAllAsync() { var entities = await _repo.GetAllAsync(); return _mapper.Map<List<DTOs.ChapterDto>>(entities); }
