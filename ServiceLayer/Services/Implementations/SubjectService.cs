...
public class SubjectService : ISubjectService
{
    ...
    public async Task<List<DTOs.SubjectDto>> GetAllAsync() { var entities = await _repo.GetAllAsync(); return _mapper.Map<List<DTOs.SubjectDto>>(entities); }
    public async Task<DTOs.SubjectDto?> GetByIdAsync(string id) { var entity = await _repo.GetByIdAsync(id); return _mapper.Map<DTOs.SubjectDto>(entity); }
